...
**Total**     |              |
| **450.0**           |        **657.1**	          | **46**
--   ----------|--- ------    |h exact transaction times, i.e. time is measured on a continuous scale. This means we can also plot the payment pattern against development on a continuous scale:
...
# Conclusion
This blog presents a ne
wly released, [open source](https://github.com/agi-lab/SynthETIC) individual claim simulator, [`SynthETIC`](https://CRAN.R-project.org/package=SynthETIC), and highlights some of its main functionalities through a quick demo.
